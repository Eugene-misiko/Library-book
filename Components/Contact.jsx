...
function Contact(){
    return (
        <>
        <Navbar />
      <section className="bg-gradient-to-b from-pink-500 via-purple-500 to-pink-500 p-2 text-white h-screen " >
        <div className="  justify-center items-center 
        space-y-4   bg-pink-450 p-3 text-center m-30
        rounded-lg mt-20 shadow-lg  max-w-md w-full mx-auto">
            <h1>You can reach us by filling the form</h1>
